			...
			<div class="step-booking-box">
				...
				<div class="step-booking-top-middle">
					<div class="booking-datepicker">
						...
						<input type="hidden" id="datepicker" name="date" value="<?php echo $date ?>" readonly="readonly">
						<input type="hidden" id="booking_type" name="booking_type" value="" readonly="readonly">
...
$(document).ready(function(){
	...
	/*$(".day.active","#main-box").each(function() 
	{
    	alert('s');
	});*/
	...
	$('#calendarTemplate').yacal({
		...
		$("#datepicker").val(selectedsessiondate);
		$(this).addClass('selected_new');
		initComponent(selectedsessiondate);
	}
*/
