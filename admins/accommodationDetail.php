      ...
      <div class="right_col" role="main">
		...
		$res_cus = mysqli_query($con,$cus_detail);
		 ...
		 if(mysqli_num_rows($res_cus)>0){?>
			...
			<button type="button" class="btn btn-primary" onClick="window.location='accommodationManagement.php'">Back</button>
			...
			<button type="button" class="btn btn-primary" onClick="window.location='accommodationManagement.php?id=<?php echo $data['id']?>&send=1'">Send Link</button>
			<?php } else {?>
