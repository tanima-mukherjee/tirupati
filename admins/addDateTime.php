<?php
    ...
    if(isset($_POST['date']))
    {
	  ...
	  $sql = "select id from  date_time where `date`='".$date."' and `time`='".$time."' ";
	  ...
	  if($num==0)
	  {
			  ...
			  {
				$msg = "Date Time Added Successfully";
				header('location:dateTimeManagement.php?success=1&msg='.$msg);
			  }
			  else
			  {
				 $msg = "Date Time Added Failed";
...
<head>
  ...
  <title>Tirupati | Add Date Time </title>
                ...
                <form action="" method="POST"> 
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" id="time" name="time">
						...
						<option><?php echo $res['time']?></option>
