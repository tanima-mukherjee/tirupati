      ...
      <div class="right_col" role="main">
		  ...
		  <?php if($flag==0 && $msg!=""){?>
			 ...
			 <?php  } ?>
				...
				<div class="col-md-6">
					<div class="table-responsive">
						...
						<table class="table">
							<thead>
							<tr>
								<th colspan="2">Customer & Order Details</th>								
							 </tr>
						</thead>
						<tbody>
							<tr>
              ...
              <tr>
				...
				$jsondata = str_replace("'",'"',$data['room_info']);
				...
				<div class="table-responsive">
					<table class="table">
						<thead>
						<tr>
							<th colspan="4">Room Details</th>								
						 </tr>
					</thead>
					<tbody>
						<tr>
							<td><strong>Selected Room</strong></td>
							<td><strong>Number of room</strong></td>
							<td><strong>Price</strong></td>
							<td><strong>Total Price</strong></td>
						</tr>
						
						<?php for($i=0;$i<count($json_arr['room_detail']['selected_room']);$i++){?>
						<tr>
							<td><?php echo $json_arr['room_detail']['selected_room'][$i]['type'];?></td>
							<td><?php echo $json_arr['room_detail']['selected_room'][$i]['qty'];?></td>
							<td><?php echo $json_arr['room_detail']['selected_room'][$i]['price'];?></td>
							<td><span class="total-price"><?php echo $json_arr['room_detail']['selected_room'][$i]['total'];?></span></td>
						</tr>
						...
						<tr>
							<td colspan="3" align="right"><strong>Service Tax</strong></td>
							<td><span class="total-price"><?php echo $json_arr['room_detail']['service_tax'];?></span></td>							
						</tr>
						<tr>
							<td colspan="3" align="right"><strong>Swach Tax</strong></td>
							<td><span class="total-price"><?php echo $json_arr['room_detail']['swatch_tax'];?></span></td>							
						</tr>
						<tr>
							<td colspan="3" align="right"><strong>Luxury Tax</strong></td>
							<td><span class="total-price"><?php echo $json_arr['room_detail']['luxury_tax'];?></span></td>							
						</tr>
						
						<tr>
							<td colspan="3" align="right"><strong>Total</strong></td>
							<td><span class="total-price"><?php echo $json_arr['room_detail']['total'];?></span></td>							
						</tr>
		...
		$res_cus = mysqli_query($con,$cus_detail);
		 ...
		 if(mysqli_num_rows($res_cus)>0){?>
			...
			<button type="button" class="btn btn-primary" onClick="window.location='initiateAccommodationManagement.php'">Back</button>
			<!--<button type="button" class="btn btn-delivered" onClick="window.location='accommodationManagement.php?id=<?php echo $data['id']?>&refund=1'">Refund</button>
			<button type="button" class="btn btn-primary" onClick="window.location='accommodationManagement.php?id=<?php echo $data['id']?>&deliver=1'">Delivered</button>-->
			<button type="button" class="btn btn-primary" onClick="window.location='initiateAccommodationManagement.php?id=<?php echo $data['id']?>&send=1'">Send Link</button>
			<?php } else {?>
